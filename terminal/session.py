...
Independent session state for the Convexity terminal.
...
The session does not execute commands.
Execution belongs to the executor/process layers.
"""
...
class TerminalSession:
    ...
    The session stores its own cwd and never calls os.chdir().
    """
    ...
    def __init__(
        ...
        *,
        ...
        self._cwd = self._resolve_directory(cwd)
        ...
        self.maple_session_id: Optional[str] = None
    ...
    def change_directory(
        ...
        self._cwd = self._resolve_directory(directory)
    ...
    def set_env(
        ...
        self.environment[str(name)] = str(value)

    def unset_env(self, name: str) -> bool:
        self._ensure_open()
        return self.environment.pop(name, None) is not None
    ...
    def load_maple(
        ...
        *,
        ...
        self.maple_session_id = (
            maple_session_id or uuid.uuid4().hex
        )

        self.maple_metadata = dict(metadata or {})
    ...
    def register_job(self, job_id: int) -> None:
        self._ensure_open()
        self.active_jobs.add(int(job_id))

    def unregister_job(self, job_id: int) -> None:
        self._ensure_open()
        self.active_jobs.discard(int(job_id))
    ...
    def list_jobs(self) -> list[int]:
        self._ensure_open()
        return sorted(self.active_jobs)
    ...
    def snapshot(
        ...
        *,
        ...
        result = {
            ...
            "maple_session_id": self.maple_session_id,
...
class SessionManager:
    """Manage multiple independent Convexity sessions."""
    ...
    def create(self, **kwargs) -> TerminalSession:
...
def create_session(
    **kwargs,
    ...
    """Convenience function for creating a default-managed session."""
...
def get_session(
    ...
    """Convenience function for retrieving a session."""
